...
Items 1 through 13 and item 15 are exact structural, centering, reindexing, and transfer theorems. They do not by themselves provide the unresolved analytic cancellation estimate. Item 14 is the one asymptotic theorem rather than an exact identity, and its scope is stated precisely in the next section.
