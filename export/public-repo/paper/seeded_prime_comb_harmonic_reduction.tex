...
The deterministic Python validation program for this section is available directly at
\begin{center}
\href{https://github.com/OVVO-Financial/prime-wheel-mobius/blob/main/numerics/primorial_block_validation.py}{\texttt{numerics/primorial\_block\_validation.py}}.
\end{center}
