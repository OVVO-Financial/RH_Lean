...
This file contains only finite identities. It uses RH_Lean for the discovered coefficient and Fubini identity, but none of the RH proof architecture. The subsequent analytic proof is classical.
