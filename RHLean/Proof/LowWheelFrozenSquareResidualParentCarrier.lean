...
/-- Global tagged q^2 daughter carrier after #668. -/
...
/-- The tagged carrier is exactly the nested `A,q,d` sum from #668. -/
...
/-- **Parent-product completion of #668.**  The complete frozen square residual
...
/-- Combining #668 with the parent-product completion removes every auxiliary
