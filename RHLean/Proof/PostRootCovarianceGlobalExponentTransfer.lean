...
convention.  This is the converse of the #599 bootstrap. -/
...
/-- **The whole tower is one proposition.**  The #600 Mertens square envelope
and the #599 post-root power remainder are equivalent, so no reduction in the
...
step.**  Combining the #600 record threshold with the seat bound removes every
...
square alone, via #601's cumulative square-gap charge. -/
