...
`MatchedCoreBound C R : ‖core R‖ ≤ C * R`
...
/-- **The remaining open bound**, with the constant free. -/
...
/-- A core bound gives a matched bound, with the elementary seven-strip loss. -/
...
/-- **The branch target, with no fixed constant.**  Everything reduces to the
core bound; the seven-term strip is absorbed by the triangle inequality. -/
