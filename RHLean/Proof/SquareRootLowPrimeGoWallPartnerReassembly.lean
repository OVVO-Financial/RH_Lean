...
minus the common fixed column already present in the #481 wall identity. -/
...
existing `B_q` boundary states and #481 fixed column; it is not introduced as a
...
unfinished #481 old-prime owners; completed predecessor cubes contribute zero. -/
...
#481 moving-column endpoint.  This is a theorem about the boundary ledger, not
its definition. -/
