...
/-!
# Physical q^2 bookkeeping synthesis after #665
...
* For every prime `q >= 3`, the full physical `q^2` hit carrier partitions
  ...
  genuine q^2 daughter over those owner fibres therefore recovers the #665
...
/-! ## 3. #665 plus generic owner partition = exact recursive daughter -/
...
false coefficient-L2/Mertens-energy identification guarded against by #662. -/
