...
The post-#677 hard far packet is already the negative frozen/top/far residual.
...
post-#677 physical residual rather than living in a parallel coordinate system.
-/
...
/-- **Exact adaptive zero-factor representation of the post-#677 hard packet.**
