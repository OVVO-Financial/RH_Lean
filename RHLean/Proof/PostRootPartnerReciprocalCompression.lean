...
PR #683 identifies every post-root adaptive raw boundary with the intact
...
The #683 partner column is therefore already on the reciprocal carrier after
...
/-- **Literal #683 -> #540 composition.**  The reciprocal-normalized post-root
...
the transported survivor ledger already named by #540. -/
