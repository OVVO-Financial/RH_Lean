...
The finite-horizon envelope of #600 advances only at a positive record, and its
...
* **Exact wall split.**  The one-step innovation budget of #600 splits *without
...
/-- **Exact wall split.**  The #600 innovation budget is the physical outer row
...
/-- Uniform boundedness of the #600 Mertens square envelope. -/
...
absorption envelope bounds the whole #600 running envelope, anchored at the
