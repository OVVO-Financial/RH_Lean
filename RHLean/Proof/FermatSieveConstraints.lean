...
theorem fermatDigitCongruence_one_iff
    (a b : FermatDigit) :
    FermatDigitCongruence ⟨1, by decide⟩ a b ∧ Odd a.val ∧ Even b.val ↔
      (a.val = 1 ∧ b.val = 0) ∨
      (a.val = 5 ∧ b.val = 2) ∨
      (a.val = 5 ∧ b.val = 8) ∨
      (a.val = 9 ∧ b.val = 0) := by
...
theorem fermatDigitCongruence_three_iff
    (a b : FermatDigit) :
    FermatDigitCongruence ⟨3, by decide⟩ a b ∧ Even a.val ∧ Odd b.val ↔
      (a.val = 2 ∧ b.val = 1) ∨
      (a.val = 2 ∧ b.val = 9) ∨
      (a.val = 8 ∧ b.val = 1) ∨
      (a.val = 8 ∧ b.val = 9) := by
...
theorem fermatDigitCongruence_seven_iff
    (a b : FermatDigit) :
    FermatDigitCongruence ⟨7, by decide⟩ a b ∧ Even a.val ∧ Odd b.val ↔
      (a.val = 4 ∧ b.val = 3) ∨
      (a.val = 4 ∧ b.val = 7) ∨
      (a.val = 6 ∧ b.val = 3) ∨
      (a.val = 6 ∧ b.val = 7) := by
...
theorem fermatDigitCongruence_nine_iff
    (a b : FermatDigit) :
    FermatDigitCongruence ⟨9, by decide⟩ a b ∧ Odd a.val ∧ Even b.val ↔
      (a.val = 3 ∧ b.val = 0) ∨
      (a.val = 5 ∧ b.val = 4) ∨
      (a.val = 5 ∧ b.val = 6) ∨
      (a.val = 7 ∧ b.val = 0) := by
