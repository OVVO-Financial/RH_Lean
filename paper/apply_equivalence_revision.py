...
""",
"""For the exact low/high split, define
\begin{align}
...
""",
"""It is pinned to mathlib \texttt{v4.24.0} and currently imports thirty-nine theorem modules.  The source audit rejects \texttt{sorry}, \texttt{admit}, newly introduced axioms, and hidden theorem substitutes; the full library is built with warnings treated as errors.
""")

old_bridge = r"""\subsection{The corrected RH bridge}
...
"""
new_bridge = r"""\subsection{The concrete geometric--Mertens bridge}
...
not claim RH.
"""
replace_once(old_bridge, new_bridge)
...
""",
"""Concrete $M(x)$, exact endpoint $X_n=(n+1)^2-1$, and square interpolation
& Proved
& Formalized\\
...
""",
"""The RH connection is now a pure geometric equivalence:
\[
 \mathrm{RH}
 \quad\Longleftrightarrow\quad
...
""",
"""The paper source, Lean formalization, and numerical reproducibility materials are
maintained at
\[
...
""",
"""The SHA-256 hashes of the released script and machine-readable outputs are recorded
