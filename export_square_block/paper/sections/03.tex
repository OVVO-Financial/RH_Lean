...
\end{proof}
\leanxref{Lean support}{canonical largest-prime and cofactor arithmetic}{https://github.com/OVVO-Financial/RH_Lean/blob/main/export_square_block/lean/RHLean/Analysis/CanonicalHighSectorCore.lean}
...
\end{proof}
\leanxref{Lean proof}{canonicalCofactor_eq_one_of_endpoint_lt_two_mul_largestPrime; canonicalLargestPrimeFactor_le_half_of_ne_largestPrime}{https://github.com/OVVO-Financial/RH_Lean/blob/main/export_square_block/lean/RHLean/Analysis/CanonicalExtremePrimeSupport.lean}
