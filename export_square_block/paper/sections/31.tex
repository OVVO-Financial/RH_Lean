...
Formalization is used here as a mathematical audit: every cutoff, endpoint convention, canonical factor, sign, support condition, and unresolved analytic premise is explicit.  The canonical repository for the standalone square-block paper and its paper-facing Lean source is
\[
 \texttt{https://github.com/OVVO-Financial/RH\_Square\_Block}.
\]
