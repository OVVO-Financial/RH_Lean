...
\end{proof}
\leanxref{Lean proof}{squareBlockDeathShellDivisorMajorant_subpolynomial; squareBlockDeathIncrement_subpolynomial; squareBlockDeathUniformLocalBounded}{https://github.com/OVVO-Financial/RH_Lean/blob/main/export_square_block/lean/RHLean/Analysis/SquareBlockDeathProcess.lean}
